...
Процедура ВКМ_ВыполнитьАвтозаполнение(Договор) Экспорт
    ...
    НоменклатураАбоненскаяПлата = Константы.ВКМ_НоменклатураАбонентскаяПлата.Получить();
    ...
    ИначеЕсли НЕ ЗначениеЗаполнено(НоменклатураРаботыСпециалиста) Тогда
    ...
    Если ЗначениеЗаполнено(СуммаАбонентскойПлаты) И СуммаАбонентскойПлаты > 0 Тогда
        ...
        НоваяСтрока.Номенклатура = НоменклатураАбоненскаяПлата;
    ...
    Пока Выборка.Следующий() Цикл
        ...
        ТаблицаУслуги = Услуги.Добавить();
        ТаблицаУслуги.Номенклатура = НоменклатураРаботыСпециалиста;
        ТаблицаУслуги.Количество = Выборка.КоличествоЧасовОборот;
        ТаблицаУслуги.Сумма = Выборка.СуммаКОплатеОборот;
        ТаблицаУслуги.Цена = Выборка.СуммаКОплатеОборот / Выборка.КоличествоЧасовОборот;
